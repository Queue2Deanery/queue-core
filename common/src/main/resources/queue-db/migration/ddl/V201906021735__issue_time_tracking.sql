create or replace view issue_processing_estimation_view as
...
from issue i
    ...
    join issue_category ic on i.issue_category_id = ic.id
    join issue_processing_estimation_view ipev on (i.queue_id = ipev.queue_id and i.issue_category_id = ipev.issue_category_id)
